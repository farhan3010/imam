...
const domain = [
  "todayemail.ga", "50sale.edu.vn", "aiot.aiphone.eu.org", "edu.dmtc.press", "pengangguran.me", 
	"41054733.mail-temp.com", "derbydales.co.uk"
];
(async () => {
  try {
      ...
      if (register === 0) {
        await console.log(
          "[" +
            ...
            "]" +
            " " +
            "Tsugumi Sukses Meregisterkan Dengan Email :" +
            " " +
            `${email}`
        );
